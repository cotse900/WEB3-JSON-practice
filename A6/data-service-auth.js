...
module.exports.initialize = function () {
    return new Promise(function (resolve, reject) {
        let db = mongoose.createConnection("mongodb+srv://cotse:Ksc1930@senecaweb.vqkgl.mongodb.net/web322?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
        //%24%23
        db.on('error', (err)=>{
